...
int main() {
	...
	static_assert((Stone::Black | Stone::Black | Stone::Black | Stone::White).front() == Stone::Black, "error");
	static_assert((Stone::Black | Stone::Black | Stone::Black | Stone::White).back() == Stone::White, "error");
}